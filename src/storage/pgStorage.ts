...
const COLUMN_EXCHANGER = ['accountId', 'accountType', 'afterStateHash', 'afterStates', 'amountSpent', 'amountSpent_decimal', 'appReceiptData', 'appliedReceipt', 'applyTimestamp', 'beforeStateAccounts', 'beforeStateHash', 'beforeStates', 'blockHash', 'blockNumber', 'contractAddress', 'contractInfo', 'contractType', 'cycleMarker', 'cycleRecord', 'ethAddress', 'eventName', 'executionShardKey', 'externalIp', 'externalPort', 'globalModification', 'internalTx', 'isGlobal', 'isInternalTx', 'numberHex', 'originalTxData', 'penalty', 'publicKey', 'readableBlock', 'receiptId', 'signedReceipt', 'timestampEpoch', 'tokenEvent', 'tokenFrom', 'tokenOperator', 'tokenTo', 'tokenType', 'tokenValue', 'totalStakeAmount', 'totalUnstakeAmount', 'transactionFee', 'transactionHash', 'transactionType', 'txFrom', 'txHash', 'txId', 'txTo', 'wrappedEVMAccount', 'rewardAmount', 'penaltyAmount', 'violationType', 'internalTXType']
